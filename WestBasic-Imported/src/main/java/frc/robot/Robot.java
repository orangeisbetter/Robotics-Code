...
//import com.ctre.phoenix.TalonSRX.IdleMode;
// import com.revrobotics.TalonSRXLowLevel.MotorType;
...
public class Robot extends TimedRobot {
  ...
  private XboxController green = new XboxController(0);
  ...
  public void teleopPeriodic() {
    leftMotor1.set(ControlMode.PercentOutput, (green.getLeftY() - green.getLeftX())/2);
    leftMotor2.set(ControlMode.PercentOutput, (green.getLeftY() - green.getLeftX())/2);

    rightMotor1.set(ControlMode.PercentOutput, (green.getLeftY() + green.getLeftX())/2);
    rightMotor2.set(ControlMode.PercentOutput, (green.getLeftY() + green.getLeftX())/2);
    ...
    //   if(wiimote.getRawButton(11)) { armWrist.set(Value.kForward); }
    //   if(wiimote.getRawButton(10)) { armWrist.set(Value.kReverse); }
    // }
    // if(!wiimote.isConnected()) {
  ...
  */
  ...
  //   // } else { leftMotor1.set(ControlMode.PercentOutput, 0);  leftMotor2.set(ControlMode.PercentOutput, 0);  leftMotor3.set(ControlMode.PercentOutput, 0); }
  ...
  //   // } else { rightMotor1.set(ControlMode.PercentOutput, 0);  rightMotor2.set(ControlMode.PercentOutput, 0);  rightMotor3.set(ControlMode.PercentOutput, 0); }
  // }
